    ...
    <div className='flex gap-2 flex-col bg-cyan-50 m-auto items-center h-[100vh] mx-auto my-auto p-8 '>
		...
		<div class="flex items-end flex-grow w-full space-x-2 sm:space-x-3 mt-8">
			<div class="relative flex flex-col items-center flex-grow pb-5 group">
				<span class="absolute top-0 hidden -mt-6 text-xs font-bold group-hover:block">{barItems?.Under100?.ItemCount}</span>
				<div class={`relative flex justify-center w-full h-${barItems?.Under100?.ItemCount?barItems?.Under100?.ItemCount*20:0} bg-cyan-300`}></div>
				<span class="absolute bottom-0 text-xs font-bold">{barItems?.Under100?.range}</span>
			</div>
			<div class="relative flex flex-col items-center flex-grow pb-5 group">
				<span class="absolute top-0 hidden -mt-6 text-xs font-bold group-hover:block">{barItems?.Under200?.ItemCount}</span>

				<div class={`relative flex justify-center w-full h-${barItems?.Under200?.ItemCount?barItems?.Under200?.ItemCount*20:0} bg-cyan-300`}></div>
				<span class="absolute bottom-0 text-xs font-bold">{barItems?.Under200?.range}</span>
			</div>
			<div class="relative flex flex-col items-center flex-grow pb-5 group">
				<span class="absolute top-0 hidden -mt-6 text-xs font-bold group-hover:block">{barItems?.Under300?.ItemCount}</span>

				<div class={`relative flex justify-center w-full h-${barItems?.Under300?.ItemCount?barItems?.Under300?.ItemCount*20:0} bg-cyan-300`}></div>
				<span class="absolute bottom-0 text-xs font-bold">{barItems?.Under300?.range}</span>
			</div>
			<div class="relative flex flex-col items-center flex-grow pb-5 group">
				<span class="absolute top-0 hidden -mt-6 text-xs font-bold group-hover:block">{barItems?.Under400?.ItemCount}</span>

				<div class={`relative flex justify-center w-full h-${barItems?.Under400?.ItemCount?barItems?.Under400?.ItemCount*20:0} bg-cyan-300`}></div>
				<span class="absolute bottom-0 text-xs font-bold">{barItems?.Under400?.range}</span>
			</div>
			<div class="relative flex flex-col items-center flex-grow pb-5 group">
				<span class="absolute top-0 hidden -mt-6 text-xs font-bold group-hover:block">{barItems?.Under500?.ItemCount}</span>

				<div class={`relative flex justify-center w-full h-${barItems?.Under500?.ItemCount?barItems?.Under500?.ItemCount*20:0} bg-cyan-300`}></div>
				<span class="absolute bottom-0 text-xs font-bold">{barItems?.Under500?.range}</span>
			</div>
			<div class="relative flex flex-col items-center flex-grow pb-5 group">
